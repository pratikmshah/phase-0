...
- I had trouble with adding the children but this is because I didn't read the steps correctly. I corrected it
  by creating an object first then adding the value.

How difficult was it to add and delete properties outside of the object itself?
- It was pretty simple you just use delete and then the property.

What did you learn about manipulating objects in this challenge?
- Objects are easy when you use the dot operator to access and create values vs using object literal.
